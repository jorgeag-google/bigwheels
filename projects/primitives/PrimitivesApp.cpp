...
void PrimitivesApp::Config(ppx::ApplicationSettings& settings)
{
...
void PrimitivesApp::SetupEntity(const TriMesh& mesh, const GeometryCreateInfo& createInfo, Entity* pEntity)
{
...
void PrimitivesApp::SetupEntity(const WireMesh& mesh, const GeometryCreateInfo& createInfo, Entity* pEntity)
{
