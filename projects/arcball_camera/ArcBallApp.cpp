...
void ArcBallApp::Config(ppx::ApplicationSettings& settings)
{
    settings.appName                    = "arcball_camera";
    settings.enableImGui                = true;
    settings.grfx.api                   = kApi;
    settings.grfx.swapchain.depthFormat = grfx::FORMAT_D32_FLOAT;
}

void ArcBallApp::SetupEntity(const TriMesh& mesh, const GeometryCreateInfo& createInfo, Entity* pEntity)
{
...
void ArcBallApp::SetupEntity(const WireMesh& mesh, const GeometryCreateInfo& createInfo, Entity* pEntity)
{
...
void ArcBallApp::MouseMove(int32_t x, int32_t y, int32_t dx, int32_t dy, uint32_t buttons)
{
...
void ArcBallApp::Scroll(float dx, float dy)
{
    mArcballCamera.Zoom(dy / 2.0f);
}

void ArcBallApp::Render()
{
